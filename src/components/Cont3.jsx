    ...
    <div className="bg-black text-white px-6 py-10 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#1E213A] p-6 flex flex-col items-center md:items-start">
          ...
          <h3 className="text-4xl font-bold mb-2">1.16 <span className="text-xl font-light">m/s</span></h3>
        ...
        <div className="bg-[#1E213A] p-6 flex flex-col items-center md:items-start">
          ...
          <h3 className="text-4xl font-bold">10,000 <span className="text-xl font-light">km</span></h3>
        </div>

        {/* Card 4 - Air Pressure */}
        <div className="bg-[#1E213A] p-6 flex flex-col items-center md:items-start">
          <p className="mb-2">Air Pressure</p>
          <h3 className="text-4xl font-bold">1018 <span className="text-xl font-light">mb</span></h3>
        </div>
      </div>
    </div>
  );
